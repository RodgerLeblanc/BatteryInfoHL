...
static const char qt_meta_stringdata_Service[] = {
    ...
    "condition\0"
    "onConditionChanged(bb::device::BatteryCondition::Type)\0"
    "cycleCount\0onCycleCountChanged(int)\0"
    "fullChargeCapacity\0onFullChargeCapacityChanged(int)\0"
    "level,newChargingState\0"
    "onLevelOrChargingStateChanged(int,bb::device::BatteryChargingState::Ty"
    "pe)\0"
    "present\0onPresentChanged(bool)\0rxid\0"
    "onRxidChanged(QString)\0temperature\0"
    "onTemperatureChanged(float)\0"
};
...
void Service::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onConditionChanged((*reinterpret_cast< bb::device::BatteryCondition::Type(*)>(_a[1]))); break;
        case 2: _t->onCycleCountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->onFullChargeCapacityChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->onLevelOrChargingStateChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< bb::device::BatteryChargingState::Type(*)>(_a[2]))); break;
        case 5: _t->onPresentChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 6: _t->onRxidChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 7: _t->onTemperatureChanged((*reinterpret_cast< float(*)>(_a[1]))); break;
        default: ;
        }
    }
}
